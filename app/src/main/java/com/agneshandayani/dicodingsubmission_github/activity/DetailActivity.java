...
import com.agneshandayani.dicodingsubmission_github.viewmodel.UserViewModel;
import com.agneshandayani.dicodingsubmission_github.database.DatabaseContract;
import com.agneshandayani.dicodingsubmission_github.helper.DatabaseHelper;
import com.agneshandayani.dicodingsubmission_github.helper.FavoriteHelper;
...
public class DetailActivity extends AppCompatActivity {
    ...
    String strUsername;
    ImageView imageUser;
    TextView tvUsername, tvBio, tvCompany, tvLocation, tvFollowers, tvFollowing, tvRepository;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userViewModel.getUserList().observe(this, modelUser -> {
            ...
            tvCompany.setText(modelUser.getCompany());
            tvLocation.setText(modelUser.getLocation());
